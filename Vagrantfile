...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  (1..2).each do |i|
      ...
      puppetagent_config.vm.hostname = "puppetagent0#{i}.bleecky.org"
  ...
  config.vm.define :puppetmaster do |puppetmaster_config|
    ...
    puppetmaster_config.vm.hostname = "puppetmaster.bleecky.org"
  ...
  config.vm.provision :hosts do |provisioner|
        provisioner.add_host '10.1.172.10', ['puppetmaster.bleecky.org', 'puppet', 'puppetmaster']
        provisioner.add_host '10.1.172.11', ['puppetagent01.bleecky.org', 'puppetagent01']
        provisioner.add_host '10.1.172.12', ['puppetagent02.bleecky.org', 'puppetagent02']
  end
end